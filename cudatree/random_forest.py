...
class RandomForestClassifier(object):
  ...
  def fit_init(self, samples, target):
    ...
    self.bfs_threshold = self._get_best_bfs_threshold(self.n_labels, self.n_samples)
  ...
  def _get_best_bfs_threshold(self, n_labels, n_samples):
    ...
    bfs_threshold = min(bfs_threshold, min(n_samples, 35000))
    # ...or too small
  ...
  def fit(self, samples, target, bfs_threshold = None):
    ...
    if bfs_threshold is None:
      bfs_threshold = self._get_best_bfs_threshold(self.n_labels, self.n_samples)
